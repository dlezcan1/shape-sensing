function [wv,pmat,Rmat] = fn_intgEP_3layers_Dimitri(w_init,kc1,kc2,kc3,z1_crit,z2_crit,theta0,s0,ds,L,B,Binv)
%
...
[w,throw] = fn_intgEP_2layers_Dimitri(kc1,kc2, z1_crit, w_init, theta0, L, s0,ds, B,Binv);
p = wv2r(w,L);
N = length(p);
