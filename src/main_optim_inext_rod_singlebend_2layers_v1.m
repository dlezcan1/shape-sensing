%% main_optim_inext_rod_singlebend_2layers_v1.m
...
%% optimization
scalef0_c = 1;
Cval = CostFn_inext_rod_singlebend_2layers_v1(qv,scalef0_c);
scalef_c = 1/Cval;
...
Tol = 1e-14*10^(ceil(log10(scalef_c)));
...
qv0 = qv; % initial value

LB = [-1e-6,-1e-6]; % lower bound
UB = [10,10]; % upper bound

[qv,fval,exitflag] = fmincon(@(qv) CostFn_inext_rod_singlebend_2layers_v1(qv,scalef_c),...
    qv0,[],[],[],[],LB,UB,[],options);
