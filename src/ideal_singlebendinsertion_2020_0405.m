%% ideal_singlebendinsertion_2020_0405.m
%
...
% Dimitri - Changed to make negative here for directionality change
% (visualization only)
kc_s = 0.002;%0.0017; % for soft tissue (from IROS 2017 paper)
kc_h = 0.0027; % for hard tissue (from IROS 2017 paper)
...
%% needle trajectories
kc1 = kc_s*(L1/L)^p;
w_init = [kc1;0;0]; % Dimitri changed because this is what I used for optimization
