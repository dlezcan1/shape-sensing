function y = costfn_opt_v2_singlebend_2layers_kconst(eta,kc1,kc2,data,s_m,s0,ds,theta0,z_crit,N,B,Binv,scalef)
%
...
[wv,pmat,Rmat] = fn_intgEP_v1_2layers(w_init,kc1,kc2,z_crit,theta0,s0,ds,N,B,Binv);
