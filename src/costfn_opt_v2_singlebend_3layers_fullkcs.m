function y = costfn_opt_v2_singlebend_3layers_fullkcs(eta,data,s_m,s0,ds,theta0,z1_crit,z2_crit,N,B,Binv,scalef)
%
% layer: gel-meat-gel
% kc for meat and gel is included in the optimization variables.
%
