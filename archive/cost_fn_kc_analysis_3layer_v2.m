function cost = cost_fn_kc_analysis_3layer_v2(B, Binv, kc_init1, kc_init2, kc_init3, ...
    w_init, L_init, lengths, z_crit1, z_crit2, p1, p2)
...
%% Instantiations
    ...
    % wv instantations for EP equation
        ...
        [s_crit1, s_crit2] = determine_s_crit_2layer(kc_init1_i, w_init, z_crit, lengths(i), 0, ds, B, Binv);
